...
//        case "Vietnamese": selectedCountryCuisineType = WorldCuisines.vietnamese
//        default:
//            selectedCountryCuisineType = WorldCuisines.middleEastern
//        }
//        
//        StorageManager.shared.choosedCuisine = selectedCountryCuisineType
//        StorageManager.shared.setCurrentCuisineRecipes {
...
// MARK: - Экран рецептов для выбранной страны
//class CountryRecipesViewController: UIViewController {
//    
//    var country: String?
//    
//    override func viewDidLoad() {
...
//        
//        // пример: заголовок с выбранной страной
//        let label = UILabel()
//        label.text = "Recipes from \(country ?? "")"
